...
$chromiumZip = Join-Path $dist "oldoogle-xp-chromium-extension.zip"
$firefoxXpi = Join-Path $dist "oldoogle-xp-firefox-extension.xpi"
$firefoxZip = Join-Path $dist "oldoogle-xp-firefox-extension.zip"
